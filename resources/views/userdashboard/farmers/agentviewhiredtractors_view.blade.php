...
<div class="row">
    ...
    <div class="home_centralise">
        <div class="text-center home_mgr_wrap"><span class="home_tagline">Transactions History</span>
          <h3 style="font-size:14px;"> You Have {{$hiredtractors->count()}} Farmer(s) Transactions
    ...
    <li class="list-group-item">Farmer Name: <strong style=" text-transform:uppercase;"> {{$hired->fullname}}</strong></li>
    <li class="list-group-item">Total Amount: <strong style=" text-transform:uppercase;">&#x20A6;{{$hired->amount}}</strong></li>

  <li class="list-group-item pull-right"> <a href="{{route('hired_tractors', $hired->id)}}" class="btn btn-xs btn-success"><i class="fa fa-eye"></a></i>
    <li class="list-group-item pull-right" style="background:yellow; "> <strong style="background:red; text-transform:uppercase; color:#fff;">{{$hired->transaction_status}}</strong></li>

    <li class="list-group-item">Reference ID: <strong style=" text-transform:uppercase;">{{$hired->paystack_ref}}</strong></li>
