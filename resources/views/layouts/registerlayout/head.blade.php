<head>
    ...
    <title>TOG | Register as a farmer, operator or agent</title>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/user/base.css')}}">
        <link rel="stylesheet" type="text/css" href="{{asset('assets/user/loading.css')}}">
        <script src="{{asset('assets/user/js/loading.js')}}"></script>
