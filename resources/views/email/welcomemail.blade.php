...
<h3 style="font-size:14px; margin-left: -15px; margin-top: -6px; font-weight:bold; color:#fff;">TRACTORONTHEGO</h3>
...
<div style="font-size:1px;line-height:45px"> </div><img align="center" alt="Image" border="0" class="center fixedwidth" src="{{asset('assets/img/mail/tractor.png')}}" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; width: 100%; max-width: 540px; display: block;" title="Image" width="540"/>
<!--[if mso]></td></tr></table><![endif]-->
</div>
...
<p style="font-size: 34px; line-height: 1.5; text-align: center; font-family: inherit; word-break: break-word; mso-line-height-alt: 51px; margin: 0;"><span style="font-size: 34px;"><strong><span style="font-size: 34px;"><span style="color: #2190e3; font-size: 34px;">{{$users->fullname}}</span></span></strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
