    ...
    .controller('homeCtrl', ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.reverseGeocode = function() {
          ...
          var geocoder = new google.maps.Geocoder();
            ...
            geocoder.geocode( { 'address':  $scope.userSelectedLga + ', '+ $scope.locationState+' , Nigeria' },
                    ...
                    function callback(response, status) {
                      if (status == "OK") {
                        ...
                        for (var i = 0; i < origins.length; i++) {
                          ...
                          console.log('ORG :'+ origins);
                          console.log('DES :'+ destinations);
                          console.log('dIS :'+ distance);
                          console.log('LEN :'+ duration);

                         console.log($scope.deslocations);
                          
                          }
                        }
                        console.log(deslocation.distance);
                      }
        ...
        function calculateCost(distance) {
          ...
          if (distanceInNumber <= constants.first50) {
            // 80,000 + VAT ()
            return 80000;
          } else {
            var difference = (distanceInNumber - 80000) * constants.costPerKm;
            return difference;
