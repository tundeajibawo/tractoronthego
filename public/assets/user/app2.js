...
angular.module('homeApp', ['ngAnimate'])
    .controller('homeCtrl', ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.onServiceChange = function (service, oldServiceName, serviceType, plan_name) {
            ...
            console.log(service.data.plans);
            console.log(service.data.name);
            console.log(service);
            console.log(oldServiceName);
